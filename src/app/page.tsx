...
export default function Home() {
  ...
  return (
    <div className="font-sora flex flex-col items-center min-h-screen w-auto p-8 gap-20 pb-20 sm:p-20 relative bg-yellow-950">
    {/* <div
    ...
    <Navbar/>
    <main className="relative flex flex-col md:flex-row w-full h-screen bg-white mt-10 py-10 md:py-0">
      <div className="w-full md:w-[60%] flex flex-col items-center justify-center gap-5">
        <h1 className="font-bodoni text-5xl md:text-7xl lg:text-8xl font-bold text-black text-center">
          $Phaser <br /> Art Gallery
        </h1>
        <p className="text-black text-sm md:text-md mb-10">Powered by $Phaser Beary</p>
        <button className="flex bg-yellow-500 text-white text-2xl md:text-3xl p-3 rounded-md">
          All Collections
        </button>
      </div>
      <div className="w-full md:w-[35%] flex items-end">
        <Image
          width={700}
          height={100}
    ...
    <div className="bg-black/70 w-full flex flex-col items-center justify-center gap-5 md:gap-10 py-10">
      <h1 className="text-2xl md:text-6xl font-bold">Top Artists</h1>
      <div className="flex flex-row items-center justify-center gap-2 md:gap-10">
        <img src="/assets/beary/1.png" className="w-12 h-12 md:w-35 md:h-35 rounded-full" alt="" />
        <img src="/assets/beary/1.png" className="w-12 h-12 md:w-35 md:h-35 rounded-full" alt="" />
        <img src="/assets/beary/1.png" className="w-12 h-12 md:w-35 md:h-35 rounded-full" alt="" />
        <img src="/assets/beary/1.png" className="w-12 h-12 md:w-35 md:h-35 rounded-full" alt="" />
        <img src="/assets/beary/1.png" className="w-12 h-12 md:w-35 md:h-35 rounded-full" alt="" />
    ...
    <div className="bg-black/70 w-full flex flex-col items-center justify-center gap-10 py-10 px-5 md:px-10 mb-10">
      <h1 className="text-2xl md:text-6xl font-bold">Top Artworks</h1>
