...
import { Sora, Inter, Frijole, Comic_Neue, Caveat, Permanent_Marker, Gloria_Hallelujah, Andika, Bodoni_Moda, Old_Standard_TT } from "next/font/google";
import "./globals.css";
...
const bodoniModa = Bodoni_Moda({variable: "--font-bodoni", subsets: ["latin"], weight: ["400", "700"],});
const oldStanndartTT = Old_Standard_TT({variable: "--font-old", subsets: ["latin"], weight: ["400", "700"],});

export const metadata: Metadata = {
  title: "$Phaser Beary Art Gallery",
  description: "Powered by $Phaser Beary.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${sora.variable} ${inter.variable} ${frijole.variable} ${comicNeue.variable} ${caveat.variable} ${permanentMarker.variable} ${gloriaHallelujah.variable} ${bodoniModa.variable} ${oldStanndartTT.variable}`}>
